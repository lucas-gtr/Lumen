...
bool OutputFormatHdr::write_image(const std::string& /*file_path*/, int /*width*/, int /*height*/,
                                  int /*channel_count*/, const unsigned char* /*image*/) const {
...
bool OutputFormatHdr::write_image_hdr(const std::string& file_path, int width, int height, int channel_count,
                                      const float* image) {
