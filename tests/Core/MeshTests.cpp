...
TEST(MeshTest, ParameterizedConstructorTest) {
    Vertex v1 {Eigen::Vector3d(1.0, 2.0, 3.0), Eigen::Vector3d(0.0, 1.0, 0.0), Eigen::Vector2d(0.5, 0.5)};
    Vertex v2 {Eigen::Vector3d(4.0, 5.0, 6.0), Eigen::Vector3d(0.0, 0.0, 1.0), Eigen::Vector2d(0.25, 0.25)};
    Vertex v3 {Eigen::Vector3d(7.0, 8.0, 9.0), Eigen::Vector3d(1.0, 0.0, 0.0), Eigen::Vector2d(0.75, 0.75)};
    Face f1 {{0, 1, 2}};
...
TEST(MeshTest, VertexEquality) {
  Vertex v1 {Eigen::Vector3d(1.0, 2.0, 3.0), Eigen::Vector3d(0.0, 1.0, 0.0), Eigen::Vector2d(0.5, 0.5)};
  Vertex v2 {Eigen::Vector3d(1.0, 2.0, 3.0), Eigen::Vector3d(0.0, 1.0, 0.0), Eigen::Vector2d(0.25, 0.25)};
  EXPECT_NE(v1, v2); // Identical positions and normals, different texcoords

  Vertex v3 {Eigen::Vector3d(1.0, 2.0, 3.0), Eigen::Vector3d(0.0, 0.0, 1.0), Eigen::Vector2d(0.5, 0.5)};
  EXPECT_NE(v1, v3); // Identical positions and texcoords, different normals

  Vertex v4 {Eigen::Vector3d(4.0, 5.0, 6.0), Eigen::Vector3d(0.0, 1.0, 0.0), Eigen::Vector2d(0.5, 0.5)};
  EXPECT_NE(v1, v4); // Identical normals and texcoords, different positions

  Vertex v5 {Eigen::Vector3d(1.0, 2.0, 3.0), Eigen::Vector3d(0.0, 1.0, 0.0), Eigen::Vector2d(0.5, 0.5)};
  EXPECT_EQ(v1, v5); // Identical positions, normals, and texcoords

  Vertex v6 {Eigen::Vector3d(7.0, 8.0, 9.0), Eigen::Vector3d(1.0, 0.0, 0.0), Eigen::Vector2d(0.75, 0.75)};
