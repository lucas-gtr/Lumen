...
private:
  ...
  virtual const ITextureGPU* addTexture(const Texture& texture) = 0;
...
public:
   ...
   */
  virtual void addLight(const SpotLight& light) = 0;
   ...
   */
  virtual void setSkyboxTexture(const Texture& texture) = 0;

  virtual void deleteSkyboxTexture() = 0; ///< Deletes the current skybox texture.
